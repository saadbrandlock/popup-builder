...
import { usePublishedTemplatesListing } from '../hooks/use-published-templates-listing';
...
interface PublishedTemplatesQueueProps extends BaseProps {}

export const PublishedTemplatesQueue: React.FC<PublishedTemplatesQueueProps> = ({
  apiClient,
  navigate,
  shoppers,
  accountDetails,
    ...
    },
    {
      ...
      render: (_: unknown, record: AdminReviewQueueItem) => (
        <Button
          type="default"
          size="small"
          onClick={() => handleView(record.account_id)}
        >
          View
        </Button>
      ),
